 ...
 * \brief The commun.social smart contract allows the user to create own profile, pin-list and «black» list.
 */
 ...
 * \ingroup social
 *
 * \details The commun.social smart contract provides a user the following features:
